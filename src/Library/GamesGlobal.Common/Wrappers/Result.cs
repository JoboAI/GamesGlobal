...
public class Result : IResult
{
    ...
    private static IResult Fail(List<string> messages)
    {
...
public class Result<T> : Result, IResult<T>
{
    ...
    private static Result<T> Fail()
    {
        return new Result<T> { Succeeded = false };
    }

    private static Result<T> Fail(string message)
    {
        return new Result<T> { Succeeded = false, Messages = new List<string> { message } };
    }

    private static Result<T> Fail(List<string> messages)
    {
    ...
    private static Result<T> Success(string message)
    {
